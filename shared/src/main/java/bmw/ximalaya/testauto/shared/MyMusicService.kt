...
import bmw.ximalaya.testauto.shared.*
...
//                            it.displayIconUri = jsonMusic.image
    ...
    private fun createLibrary(mediaItems: MutableList<MediaBrowserCompat.MediaItem>) {
        ...
        mediaDescriptionBuilder.setIconUri(Uri.parse("https://storage.googleapis.com/uamp/The_Kyoto_Connection_-_Wake_Up/art.jpg"))
